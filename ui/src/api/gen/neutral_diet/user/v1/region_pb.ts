...
// @generated from file neutral_diet/user/v1/region.proto (package neutral_diet.user.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message neutral_diet.user.v1.Region
 */
export class Region extends Message<Region> {
  ...
  static readonly typeName = "neutral_diet.user.v1.Region";
